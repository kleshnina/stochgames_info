function [pi,coop,Str]=SimEvolution_N(q,b1,b2,c,N,beta,epsi)

% [W,w1,w2,pi,coop]=SimEvolution_N(q,b1,b2,c,N1,N2,beta,epsi);
% INPUT:
...
%% Preparations
nStr=2^4; % Initiating all memory-1 strategies
Str=zeros(nStr,4); 
for i=1:nStr
    Str(i,:)=sscanf(dec2bin(i-1,4), '%1d' )';
end
